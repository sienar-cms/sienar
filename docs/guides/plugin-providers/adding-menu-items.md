...
All of our examples use the [DashboardMenuNames](xref:Sienar.Infrastructure.DashboardMenuNames) class and its `MainMenu` constant. This class is contained in the `Sienar.Infrastructure` namespace, which is already imported if you followed along with the example code in the [first page](index.md) of this tutorial
...
{
    app.ConfigureMenu(menuProvider =>
	{
		menuProvider
